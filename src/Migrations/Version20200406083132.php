 ...
 */
final class Version20200406083132 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD type_user LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', DROP type_user_id');
    }
